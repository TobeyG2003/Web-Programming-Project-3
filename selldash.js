...
function createMessagesCard(message) {
    const messcard = document.createElement('div');
    messcard.classList.add('messages-temp');


    messcard.innerHTML = `
        <img src="${message.imageUrl}" alt="${message.user}"
    ...
    document.getElementById('messages-card').appendChild(messcard);
}
